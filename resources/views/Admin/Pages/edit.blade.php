...
@section('content')
    ...
    <div class="d-flex justify-content-center">
        <form action="{{ route('painel.pages.update', ['id' => $page->id]) }}" method="POST" class="form-horizontal col-sm-8">
            @csrf
            @method('PUT')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="content" id="content" class="form-control contentfield">{{ $page->content }}</textarea>
                        </div>
                    </div>
                </div>
